const Itemprod = ({ state }) => {
    const produceItemByManufacturer = async (event) => {
        ...
        const manufacturerInformation = document.querySelector("#manufacturerInformation").value;
        const productNotes = document.querySelector("#productNotes").value;
        const productPrice = document.querySelector("#productPrice").value;
        const transaction=await contract.produceItemByManufacturer(stockunit,productCode,manufacturerName,manufacturerInformation,productNotes,productPrice) // function from smart contract
        await transaction.wait();
        console.log(stockunit, productCode, manufacturerInformation, manufacturerName, productNotes, productPrice);
